    ...
    <tr>
        <td align="center" style="padding:0 12px;">
            <table role="presentation" width="600" cellpadding="0" cellspacing="0"
                   style="max-width:600px;width:100%;background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 6px 24px rgba(16,24,40,.08);">
                ...
                <tr>
                    <td style="padding:22px 24px;background:linear-gradient(135deg,#0ea5e9,#10b981);">
                        ...
                        <div
                            style="margin-top:6px;font-size:12px;color:rgba(255,255,255,.92);letter-spacing:.08em;text-transform:uppercase;">
                            New Contact Request
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:26px 24px;">
                        <h1 style="margin:0 0 10px;font-size:20px;line-height:28px;color:#0f172a;">
                        ...
                        @if(!empty($room))
                            ...
                            <div style="margin-top:16px;">
                                ...
                                @if(!empty($roomUrl))
                                    ...
                                    <div
                                        style="margin-top:10px;padding:12px 14px;background:#f1f5f9;border-radius:10px;">
